...
public class RedFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(cont, "onCreate", Toast.LENGTH_SHORT).show();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Toast.makeText(cont, "onCreateView", Toast.LENGTH_SHORT).show();
    ...
    public void onAttach(Context context) {
        ...
        this.cont = context;
        Toast.makeText(cont, "onAttach", Toast.LENGTH_SHORT).show();
    ...
    public void onStart() {
        super.onStart();
        Log.wtf("red", "onStart");
        Toast.makeText(cont, "onStart", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onResume() {
        ...
        Toast.makeText(cont, "onResume", Toast.LENGTH_SHORT).show();
    }
}
